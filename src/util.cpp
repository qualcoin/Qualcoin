...
int nAnonymizequalcoinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\qualcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\qualcoin
    // Mac: ~/Library/Application Support/qualcoin
    // Unix: ~/.qualcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "qualcoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "qualcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "qualcoind.pid"));
