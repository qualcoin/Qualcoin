...
int nCoinbaseMaturity = 59; // 60 in total
...
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);  // 24.2% yearly interest 
    
    return nSubsidy + nFees;
}

static int64_t nTargetTimespan = 14 * 60;  // 14 mins
