...
#define START_MASTERNODE_PAYMENTS_TESTNET 1543920612 // Tuesday, 4 December 2018 10:50:12
#define START_MASTERNODE_PAYMENTS 1544100937 //  Thursday, 6 December 2018 12:55:37
...
*/
#define INSTANTX_SIGNATURES_REQUIRED           12
#define INSTANTX_SIGNATURES_TOTAL              16
...
#define MASTERNODE_MIN_CONFIRMATIONS           14
...
static const unsigned int MAX_BLOCK_SIZE = 100000000; // 100 megabyte blocks
...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 440;
/** The maximum number of entries in an 'inv' protocol message */
static const unsigned int MAX_INV_SZ = 50000;
/** Fees smaller than this (in satoshi) are considered zero fee (for transaction creation) */
static const int64_t MIN_TX_FEE = 100000; // 0.001 per kb
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 2000000000 * COIN; // 2 Billion
...
static const int64_t TARGET_SPACING = 10; // 10 second block times expected
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const unsigned int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
/** Future Drift time set in seconds */
static const int64_t DRIFT = 900; // 15 min drift time
